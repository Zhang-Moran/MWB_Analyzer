...
def train(opt, device):
    ...
    train_images_path, train_images_label = read_video_data(os.path.join(data_dir, "train2"))
    val_images_path, val_images_label = read_video_data(os.path.join(data_dir, "val2"))
    ...
    model = VideoClassificationModel9()  # convert to classification model
    
    # from thop import profile
    # input_tensor = torch.randn(1, 24, 640, 640)
    ...
    # pretrained_model = torch.load('/home/lsh/yolov5_7.0/yolov5/runs/train-cls/exp21/weights/best.pt')
    # pretrained_dict = pretrained_model['model'].state_dict()
    ...
    # weights_dict = torch.load('/home/lsh/yolov5_7.0/yolov5/runs/train-cls/exp21/weights/best.pt', map_location=device)
    # model.load_state_dict(weights_dict["model"].state_dict())
